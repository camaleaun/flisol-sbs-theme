...
(function () {
     ...
     */
    window.getObject = function (objectName, source) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.isInstance = function (object, clazz) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.booleanValue = function (object, trueChars) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.isUndefined = function (object) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.invoke = function (functionName, args) {
        var arguments;
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: The invocation return value
     */
    window.invokeAsMethod = function (object, method, args) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: The array
     */
    window.ensureArray = function (object) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: The index
     */
    window.indexOf = function (object, array, startingAt) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.inArray = function (object, array) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.removeFromArray = function (array) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: The concatenation of the two arrays
     */
    window.arrayEquals = function (array1, array2) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.checkAll = function (object, flag) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.observeEvent = function (object, eventName, handler) {
        object = getObject(object);
        if (object != null) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.typedCode = function (event) {
        var code = 0;
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.prepareForCaret = function (object) {
        object = getObject(object);
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.isCaretSupported = function (object) {
        object = getObject(object);
        if (object == null || !object.type) {
            return false;
        }
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.isInputSelectionSupported = function (object) {
        object = getObject(object);
        if (object == null || !object.type) {
            return false;
        }
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.getInputSelection = function (object) {
        object = getObject(object);
        if (object == null || !object.type) {
            return null;
        }
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.getInputSelectionRange = function (object) {
        object = getObject(object);
        if (object == null || !object.type) {
            return null;
        }
...
///////////////////////////////////////////////////////////////////////////////
     ...
     *     end: The selection end
     */
    window.setInputSelectionRange = function (object, start, end) {
        object = getObject(object);
        if (object == null || !object.type) {
            return;
        }
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.getCaret = function (object) {
        object = getObject(object);
        if (object == null || !object.type) {
            return null;
        }
...
///////////////////////////////////////////////////////////////////////////////
     ...
     *     pos: The position
     */
    window.setCaret = function (object, pos) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     *     object: The reference for the input
     */
    window.setCaretToEnd = function (object) {
        object = getObject(object);
        if (object == null || !object.type) {
            return;
        }
...
///////////////////////////////////////////////////////////////////////////////
     ...
     *     object: The reference for the input
     */
    window.setCaretToStart = function (object) {
        object = getObject(object);
        if (object == null || !object.type) {
            return;
        }
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.selectString = function (object, string) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     *     string: The new text
     */
    window.replaceSelection = function (object, string) {
        object = getObject(object);
        if (object == null || !object.type) {
            return;
        }
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.clearOptions = function (select) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.addOption = function (select, option, sort, textProperty, valueProperty, selectedProperty) {
        select = getObject(select);
...
///////////////////////////////////////////////////////////////////////////////
     ...
     *     selectedProperty: The object property, when not an Option, to read if the option is selected. Defaults to "selected"
     */
    window.addOptions = function (select, options, sort, textProperty, valueProperty, selectedProperty) {
        select = getObject(select);
        if (select == null) {
            return;
        }
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.compareOptions = function (opt1, opt2) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.setOptions = function (select, options, addEmpty, sort, textProperty, valueProperty, selectedProperty) {
        select = getObject(select);
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.sortOptions = function (select, sortFunction) {
        select = getObject(select);
        if (select == null) {
            return;
        }
...
///////////////////////////////////////////////////////////////////////////////
     ...
     *     sort: Will sort the options? Default: false
     */
    window.transferOptions = function (source, dest, all, sort) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.getValue = function (object) {
        object = getObject(object);
        if (object == null) {
            return null;
        }
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.setValue = function (object, value) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.ifEmpty = function (object, emptyValue) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: The first object if is not empty, otherwise the second one
     */
    window.ifNull = function (object, nullValue) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: The new string
     */
    window.repeat = function (string, times) {
        var ret = "";
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: The new string
     */
    window.ltrim = function (string, chars) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: The new string
     */
    window.rtrim = function (string, chars) {
        string = string ? String(string) : "";
        chars = chars || JST_CHARS_WHITESPACE;
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: The new string
     */
    window.trim = function (string, chars) {
        chars = chars || JST_CHARS_WHITESPACE;
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: The new string
     */
    window.lpad = function (string, size, chr) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: The new string
     */
    window.rpad = function (string, size, chr) {
        string = String(string);
        if (size <= 0) {
            return "";
        }
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: The new string
     */
    window.crop = function (string, pos, size) {
        string = String(string);
        if (size == null) {
            size = 1;
        }
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: The new string
     */
    window.lcrop = function (string, size) {
        if (size == null) {
            size = 1;
        }
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: The new string
     */
    window.rcrop = function (string, size) {
        string = String(string);
        if (size == null) {
            size = 1;
        }
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.capitalize = function (text, separators) {
        text = String(text);
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.onlySpecified = function (string, possible) {
        string = String(string);
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.onlyNumbers = function (string) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.onlyLetters = function (string) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.onlyAlpha = function (string) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: Do the String contains only lettersts?
     */
    window.onlyBasicLetters = function (string) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: Do the String contains only alphanumeric characters?
     */
    window.onlyBasicAlpha = function (string) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: The substring
     */
    window.right = function (string, n) {
        string = String(string);
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: The substring
     */
    window.mid = function (string, pos, n) {
        string = String(string);
        if (n == null) {
            n = string.length;
        }
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: The updated
     */
    window.insertString = function (string, pos, value) {
        string = String(string);
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.functionName = function (funct, unnamed) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: The string
     */
    window.debug = function (object, separator, sort, includeObject, objectSeparator) {
        if (object == null) {
            return "null";
        }
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.escapeCharacters = function (string, extraChars, onlyExtra) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.unescapeCharacters = function (string, onlyExtra) {
        var ret = String(string);
        var pos = -1;
        var u = "\\\\u";
        onlyExtra = booleanValue(onlyExtra);
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.writeCookie = function (name, value, document, expires, path, domain, secure) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: The value
     */
    window.readCookie = function (name, document) {
        document = document || self.document;
        var prefix = name + "=";
...
///////////////////////////////////////////////////////////////////////////////
     ...
     *     domain: The cookie's domain. Default: not specified
     */
    window.deleteCookie = function (name, document, path, domain) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.getDateField = function (date, field) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.setDateField = function (date, field, value) {
        if (!isInstance(date, Date)) {
            return;
        }
        switch (field) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.dateAdd = function (date, amount, field) {
        if (!isInstance(date, Date)) {
            return null;
        }
        if (amount == 0) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.dateDiff = function (date1, date2, field) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     * Returns: The new Date
     */
    window.truncDate = function (date, field) {
        if (!isInstance(date, Date)) {
            return null;
        }
        if (field == null) field = JST_FIELD_DAY;
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.getMaxDay = function (month, year) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.getFullYear = function (year) {
        year = Number(year);
        if (year < 1000) {
            if (year < 50 || year > 100) {
                year += 2000;
     ...
     */
    window.setOpacity = function (object, value) {
        object = getObject(object);
        if (object == null) {
            return;
        }
     ...
     *     object: The object name or reference
     */
    window.getOpacity = function (object) {
        object = getObject(object);
        if (object == null) {
            return;
        }
...
///////////////////////////////////////////////////////////////////////////////
     ...
     *     value: The value
     */
    window.Pair = function (key, value) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.Value = function (key, value) {
        this.base = Pair;
        this.base(key, value);
    }
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.StringMap = function (string, nameSeparator, valueSeparator, isEncoded) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.QueryStringMap = function (location) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.CookieMap = function (document) {
...
///////////////////////////////////////////////////////////////////////////////
     ...
     *     object: The object
     */
    window.ObjectMap = function (object) {
        this.object = object;
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    window.StringBuffer = function (initialCapacity) {
